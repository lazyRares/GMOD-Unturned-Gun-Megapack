...
SWEP.PrintName = "Maplestrike"
SWEP.TrueName = "C7A2 Rifle"
...
SWEP.Description = [[The Maplestrike is a Canadian assault rifle based on the C7A2 Rifle Manufactured by Colt Canada. It was added to Unturned along with the 3.0 release. it has a magazine of 35 bullets, and can be fitted with a drum magazine sporting a sizeable 75 bullets. It has a moderate fire rate, and decent damage. A good all rounder.]]
...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_maplestrike.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_maplestrike", "arc9/weaponicons/arc9_maplestrike.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_maplestrike_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_maplestrike_w.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Use this to use the viewmodel as a worldmodel.
-- Highly recommended to save effort!

SWEP.WorldModelMirror = "models/ut_weapons/ut_maplestrike_w.mdl" -- Use this to set a lower-quality version of the viewmodel, with the same bone structure, as a worldmodel, to take advantage of MirrorVMWM without having to use the viewmodel.
...
SWEP.ForceDefaultClip = 35 -- Set to force a default amount of ammo this gun can have. Otherwise, this is controlled by console variables.
...
SWEP.FirstShootSound = "weapons/arccw/maplestrike_shot.wav"  
SWEP.ShootSound = "weapons/arccw/maplestrike_shot.wav"     -- Fire      
SWEP.ShootSoundIndoor = "weapons/arccw/maplestrike_shot.wav"    -- Fire indoors
...
SWEP.FirstShootSoundIndoor = "weapons/arccw/maplestrike_shot.wav"   -- First fire indoors
SWEP.FirstDistantShootSound = "weapons/arccw/maplestrike_shot_distant.wav"                -- First distant fire
SWEP.DistantShootSound = "weapons/arccw/maplestrike_shot_distant.wav"                     -- Distant fire
SWEP.DistantShootSoundIndoor = "weapons/arccw/maplestrike_shot_distant.wav"              -- Distant fire indoors
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/lockdown_reload.wav", t = 33 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        FrameRate = 60,
        EventTable = {
            {s = "weapons/arccw/lockdown_reload_empty.wav", t = 33 / 60, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["draw"] = {
