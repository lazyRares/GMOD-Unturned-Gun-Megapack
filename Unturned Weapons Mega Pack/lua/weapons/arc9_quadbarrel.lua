...
SWEP.PrintName = "Quad Barrel"
SWEP.TrueName = "Quad Barrel"
...
SWEP.Class = "Quad Barrel Shotgun"
SWEP.Trivia = {
	Manufacturer1 = "N/A",
	Calibre2 = ".12 Gauge",
	Mechanism3 = "N/A",
...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_quadbarrel.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_quadbarrel", "arc9/weaponicons/arc9_quadbarrel.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_quad_barrel_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_quad_barrel_01.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Use this to use the viewmodel as a worldmodel.
-- Highly recommended to save effort!

SWEP.WorldModelMirror = "models/ut_weapons/ut_quad_barrel_01.mdl" -- Use this to set a lower-quality version of the viewmodel, with the same bone structure, as a worldmodel, to take advantage of MirrorVMWM without having to use the viewmodel.

SWEP.WorldModelOffset = {
	Pos = Vector(9, 0.5, 10), -- non tpik (while on ground, on npc etc) 
	Ang = Angle(0, -90, 180),
	TPIKPos = Vector(9, 0.5, 10), -- arc9_tpik 1, you can make cool poses with it
	TPIKAng = Angle(0, -90, 180),
	Scale = 1
}
...
SWEP.ForceDefaultClip = 8 -- Set to force a default amount of ammo this gun can have. Otherwise, this is controlled by console variables.
...
SWEP.RestPos = Vector(19, 30, -35) 
SWEP.RestAng = Angle(0, -15, 5)
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/quad_barrel_reload.wav", t = 22 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["reload_empty"] = {
        Source = "reload",
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/quad_barrel.wav", t = 22 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
     ["draw"] = {
