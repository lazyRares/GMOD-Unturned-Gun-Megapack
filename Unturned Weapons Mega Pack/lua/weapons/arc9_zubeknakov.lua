...
SWEP.Description = [[The Zubeknakov is a Russian assault rifle based on the AK-47 Manufactured by Kalashnikov Concern. It was added to Unturned December 7, 2014, it has a magazine of 35 bullets, and can be fitted with a drum magazine sporting a sizeable 75 bullets. It has a moderate fire rate, and decent damage. A good all rounder.]]
...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_zubeknakov.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_zubeknakov", "arc9/weaponicons/arc9_zubeknakov.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_zubeknakov_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_zubeknakov_w.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Use this to use the viewmodel as a worldmodel.
-- Highly recommended to save effort!

SWEP.WorldModelMirror = "models/ut_weapons/ut_zubeknakov_w.mdl" -- Use this to set a lower-quality version of the viewmodel, with the same bone structure, as a worldmodel, to take advantage of MirrorVMWM without having to use the viewmodel.

SWEP.WorldModelOffset = {
	Pos = Vector(11,1.5,-1), -- non tpik (while on ground, on npc etc) 
	Ang = Angle(1.5, 0, 180),
	TPIKPos = Vector(11,1.5,-1), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.FirstShootSound = "weapons/arccw/zubeknakov_shot.wav"  
SWEP.ShootSound = "weapons/arccw/zubeknakov_shot.wav"     -- Fire      
SWEP.ShootSoundIndoor = "weapons/arccw/zubeknakov_shot.wav"    -- Fire indoors
...
SWEP.FirstShootSoundIndoor = "weapons/arccw/zubeknakov_shot.wav"   -- First fire indoors
SWEP.FirstDistantShootSound = "weapons/arccw/zubeknakov_shot_distant.wav"                -- First distant fire
SWEP.DistantShootSound = "weapons/arccw/zubeknakov_shot_distant.wav"                     -- Distant fire
SWEP.DistantShootSoundIndoor = "weapons/arccw/zubeknakov_shot_distant.wav"              -- Distant fire indoors
...
SWEP.CustomizePos = Vector(1, 85, 5) 	--Customization Pos
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/zubeknakov_reload.wav", t = 33 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        FrameRate = 60,
        EventTable = {
            {s = "weapons/arccw/zubeknakov_reload_empty.wav", t = 33 / 60, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["draw"] = {
