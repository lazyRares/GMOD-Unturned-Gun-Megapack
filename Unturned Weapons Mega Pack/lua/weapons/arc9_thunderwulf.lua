...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_thunderwulf.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_thunderwulf", "arc9/weaponicons/arc9_thunderwulf.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_thunderwulf_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_thunderwulf.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"
...
SWEP.HeadshotDamage = 1.3
SWEP.ChestDamage = 1.0
...
SWEP.FirstShootSound = "weapons/arccw/thunderwulf_shot.wav"  
SWEP.ShootSound = "weapons/arccw/thunderwulf_shot.wav"     -- Fire      
SWEP.ShootSoundIndoor = "weapons/arccw/thunderwulf_shot.wav"    -- Fire indoors
SWEP.ShootSoundSilenced = "" -- Fire silenced
SWEP.ShootSoundIndoorSilenced = nil  -- Fire indoors silenced
SWEP.FirstShootSoundSilenced = nil  -- First fire silenced
SWEP.FirstShootSoundIndoor = "weapons/arccw/thunderwulf_shot.wav"   -- First fire indoors
SWEP.FirstDistantShootSound = "weapons/arccw/thunderwulf_shot.wav"                -- First distant fire
SWEP.DistantShootSound = "weapons/arccw/thunderwulf_shot.wav"                     -- Distant fire
SWEP.DistantShootSoundIndoor = "weapons/arccw/thunderwulf_shot.wav"              -- Distant fire indoors
...
SWEP.ActivePos = Vector(19, 35, -30) 
SWEP.ActiveAng = Angle(0, -4, -2) 

-- Position while walking/running (no sprint)
SWEP.MovingPos = Vector(19, 28, -35) 
SWEP.MovingAng = Angle(0, -5, -2) 

-- Position when crouchingw
SWEP.CrouchPos = Vector(19, 27,-24)  --Crouch Pos
...
SWEP.NearWallPos = Vector(15,  50, -15)
SWEP.NearWallAng = Angle(0, 90, -25)

SWEP.HolsterPos = Vector(-25, 20, -75)
SWEP.HolsterAng = Angle(120, -90, -0)
...
SWEP.CustomizePos = Vector(8, 10, -9) 	--Customization Pos
...
SWEP.Animations = {
    ...
    ["cycle"] = {
        ...
        ShellEjectAt = 0,
        EventTable = {
            {s = "weapons/arccw/bolt_cycle.wav", t = 0 / 1, c = CHAN_ITEM, shelleject = false },
		}
    },
    ["fire_iron"] = {
        Source = "fire",
    ...
    ["reload"] = {
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/thunderwulf_reload.wav", t = 22 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["reload_empty"] = {
        Source = "reload_empty",
