...
SWEP.Trivia = {
	Manufacturer1 = "Knight's Armament Company",
...
SWEP.Description = [[The Lockdown is a Greek assault rifle based on the SR-25 Manufactured by Knight's Armament Company. It was added to Unturned December 24, 2017, it has a magazine of 20 bullets, It is better suited for long range, and has high damage.]]
...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_lockdown.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_lockdown", "arc9/weaponicons/arc9_lockdown.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_lockdown_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_lockdown_w.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Use this to use the viewmodel as a worldmodel.
-- Highly recommended to save effort!

SWEP.WorldModelMirror = "models/ut_weapons/ut_lockdown_w.mdl" -- Use this to set a lower-quality version of the viewmodel, with the same bone structure, as a worldmodel, to take advantage of MirrorVMWM without having to use the viewmodel.
...
SWEP.FirstShootSound = "weapons/arccw/lockdown_shot.wav"  
SWEP.ShootSound = "weapons/arccw/lockdown_shot.wav"     -- Fire      
SWEP.ShootSoundIndoor = "weapons/arccw/lockdown_shot.wav"    -- Fire indoors
...
SWEP.FirstShootSoundIndoor = "weapons/arccw/lockdown_shot.wav"   -- First fire indoors
SWEP.FirstDistantShootSound = "weapons/arccw/lockdown_shot_distant.wav"                -- First distant fire
SWEP.DistantShootSound = "weapons/arccw/lockdown_shot_distant.wav"                     -- Distant fire
SWEP.DistantShootSoundIndoor = "weapons/arccw/lockdown_shot_distant.wav"              -- Distant fire indoors
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/lockdown_reload.wav", t = 30 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["reload_empty"] = {
        Source = "reload_empty",
