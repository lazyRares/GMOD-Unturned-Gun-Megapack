...
SWEP.PrintName = "Sportshot"
SWEP.TrueName = "Ruger 10/22 Carbine"
...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_sportshot.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_sportshot", "arc9/weaponicons/arc9_sportshot.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_sportshot_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_sportshot.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Use this to use the viewmodel as a worldmodel.
-- Highly recommended to save effort!

SWEP.WorldModelMirror = "models/ut_weapons/ut_sportshot.mdl" -- Use this to set a lower-quality version of the viewmodel, with the same bone structure, as a worldmodel, to take advantage of MirrorVMWM without having to use the viewmodel.

SWEP.WorldModelOffset = {
	Pos = Vector(9, 0.5, 2), -- non tpik (while on ground, on npc etc) 
	Ang = Angle(0, 180, 180),
	TPIKPos = Vector(9, 0.5, 2), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.ImpactForce = 5 -- Force that bullets apply on hit
...
SWEP.ChestDamage = 0.6
SWEP.StomachDamage = 0.8
SWEP.ArmDamage = 0.5
SWEP.LegDamage = 0.5
...
SWEP.ForceDefaultClip = 10 -- Set to force a default amount of ammo this gun can have. Otherwise, this is controlled by console variables.
...
SWEP.RecoilKick = 0.6 -- Camera recoil
...
SWEP.ShootVolume = 390
SWEP.ShootVolumeActual = 1
SWEP.ShootPitch = 100
SWEP.ShootPitchVariation = 0

SWEP.FirstShootSound = "weapons/arccw/sportshot_shot.wav"  
SWEP.ShootSound = "weapons/arccw/sportshot_shot.wav"     -- Fire      
SWEP.ShootSoundIndoor = "weapons/arccw/sportshot_shot.wav"    -- Fire indoors
SWEP.ShootSoundSilenced = "" -- Fire silenced
SWEP.ShootSoundIndoorSilenced = nil  -- Fire indoors silenced
SWEP.FirstShootSoundSilenced = nil  -- First fire silenced
SWEP.FirstShootSoundIndoor = "weapons/arccw/sportshot_shot.wav"   -- First fire indoors
SWEP.FirstDistantShootSound = "weapons/arccw/sportshot_shot.wav"                -- First distant fire
SWEP.DistantShootSound = "weapons/arccw/sportshot_shot.wav"                     -- Distant fire
SWEP.DistantShootSoundIndoor = "weapons/arccw/sportshot_shot.wav"              -- Distant fire indoors
...
SWEP.MovingPos = Vector(19, 23, -31) 
...
SWEP.RestPos = Vector(25, 40, -25) 
SWEP.RestAng = Angle(0, 60, 5)
...
SWEP.HolsterPos = Vector(-25, 35, -85)
SWEP.HolsterAng = Angle(90, -15, 3)
...
SWEP.CustomizePos = Vector(-14, 65, -5) 	--Customization Pos
