...
SWEP.Description = [[The Dagger is an Irish sniper rifle based on the AWN Rifle Manufactured by Accuracy International. It was added to Unturned along with the Ireland curated map on April 28rd, 2018. it has a magazine of 7 bullets, massive damage fire rate, and long range capabilities.]]
...
SWEP.CustomSelectIcon = Material("arc9/weaponicons/arc9_dagger.vtf") -- Set to use a non-autogenerated select icon

if CLIENT then
	killicon.Add( "arc9_dagger", "arc9/weaponicons/arc9_dagger.vtf", Color( 255, 255, 255, 255 ) )
end

SWEP.ViewModel = "models/ut_weapons/ut_dagger_v.mdl"
SWEP.WorldModel = "models/ut_weapons/ut_dagger_w.mdl" -- If you are going to MirrorVMWM: Put here some optimized model with collisions. Css/hl2 weapon worldmodels that are included in gmod are great for it - like "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Use this to use the viewmodel as a worldmodel.
-- Highly recommended to save effort!

SWEP.WorldModelMirror = "models/ut_weapons/ut_dagger_w.mdl" -- Use this to set a lower-quality version of the viewmodel, with the same bone structure, as a worldmodel, to take advantage of MirrorVMWM without having to use the viewmodel.

SWEP.WorldModelOffset = {
	Pos = Vector(10,1.5,-1), -- non tpik (while on ground, on npc etc) 
	Ang = Angle(1.5, 0, 180),
	TPIKPos = Vector(9,1.5,-2), -- arc9_tpik 1, you can make cool poses with it
...
SWEP.DamageMax = 85 -- Damage done at point blank range
SWEP.DamageMin = 75 -- Damage done at maximum range

SWEP.ImpactForce = 12 -- Force that bullets apply on hit

SWEP.DamageRand = 0 -- Damage varies randomly per shot by this fraction. 0.1 = +- 10% damage per shot.

SWEP.RangeMin = 0 -- How far bullets retain their maximum damage for.
SWEP.RangeMax = 9842 -- In Hammer units, how far bullets can travel before dealing DamageMin.
SWEP.Distance = 30000 -- In Hammer units, how far bullets can travel, period.
...
SWEP.ForceDefaultClip = 7 -- Set to force a default amount of ammo this gun can have. Otherwise, this is controlled by console variables.
...
SWEP.FirstShootSound = "weapons/arccw/dagger_shot.wav"  
SWEP.ShootSound = "weapons/arccw/dagger_shot.wav"     -- Fire      
SWEP.ShootSoundIndoor = "weapons/arccw/dagger_shot.wav"    -- Fire indoors
...
SWEP.FirstShootSoundIndoor = "weapons/arccw/dagger_shot.wav"   -- First fire indoors
SWEP.FirstDistantShootSound = "weapons/arccw/dagger_shot_distant.wav"                -- First distant fire
SWEP.DistantShootSound = "weapons/arccw/dagger_shot_distant.wav"                     -- Distant fire
SWEP.DistantShootSoundIndoor = "weapons/arccw/dagger_shot_distant.wav"              -- Distant fire indoors
...
SWEP.CustomizePos = Vector(-5, 110, 12)	--Customization Pos
...
SWEP.Attachments = {
    [1] = {
        ...
        Bone = "weapon",
		Pos = Vector(0.5, -15.3, 23),
        Ang = Angle(90, 0, -90),
        Category = {"optic"},
        Scale = 1.5,
        Installed = "ut_dagger_scope"
    },
    [2] = {
        PrintName = "Muzzle",
        DefaultIcon = Material("ui/att_barrel.png"),
        Bone = "weapon",
		Pos = Vector(0.5, -12, -110),
        Ang = Angle(-90, 0, -90),
        Category = {"muzzle"},
        Scale = 1.4
    },
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/dagger_reload.wav", t = 33 / 30, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        FrameRate = 60,
        EventTable = {
            {s = "weapons/arccw/dagger_reload_empty.wav", t = 33 / 60, c = CHAN_ITEM, shelleject = true },
		}		
    },
    ["cycle"] = {
        Source = {"cycle"},
        ...
        FrameRate = 30,
        EventTable = {
            {s = "weapons/arccw/bolt_cycle_dagger.wav", t = 0 / 30, c = CHAN_ITEM, shelleject = false },
        }
    },
    ["draw"] = {
         ...
         InstantIdle = false,  --For firing animations, do not delay idle. Use only for guns with long shoot anfimations
